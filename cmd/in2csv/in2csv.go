...
var In2CSVCMD = &cli.Command{
	Name:        "in2csv",
	Usage:       "将常见表格数据格式转换为CSV.",
	UsageText:   `scsv in2csv [命令选项] [参数...]`,
	Action:      in2CSVAction,
	Description: cs.Color("[light_red]某些命令行选项只适用于特定的输入格式.[reset]"),
	Flags: []cli.Flag{
...
func in2CSVAction(ctx *cli.Context) error {
	return nil
}
